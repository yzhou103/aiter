...
// ============================================================================
// fp8 block-scale uniform traits (Route B fp8: 4-wave full-tile, MFMA
// 16x16x128, 128x128 blockscale, PGR1 + sched_group_barrier, DIRECT store to
// Y). Same 9-param shape as the bf16 uniform traits but fp8 A/B (W_K=128) and
// a GROUP_ scale tuple; used by the a8w8_uniform_scale kids (700/701).
// ============================================================================
template<int BLOCK_SIZE_,
        typename BLOCK_,
        typename DTYPE_,
